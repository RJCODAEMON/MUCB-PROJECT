                        ...
                        <form class="needs-validation" action="/save" method="POST" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="email" class="form-control" id="eamil" name="email" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                        Valid first name is required.
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="mobile" name="mobile" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                        Valid Phone is required.
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="country">Country / Regioun <span
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="postcode" name="zipcode" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 mb-3 password" id="password">
                                    <label for="password">Create account password <span
                                            class="text-danger">*</span></label>
                                    <input type="password" class="form-control mt-2" id="password" name="password" placeholder=""
                                        value="" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="dealername" name="dealership_name" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="dealership_phone" name="dealership_phno" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="saleperson_name	">Sales Person Name <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="saleperson_name" name="saleperson_name"placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="stock" name="stock" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="ext_color" name="ext_color" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                        Valid first name is required.
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="phy_add" name="phy_add" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                        Valid first name is required.
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="loc_city">Vehical Locatin City <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="loc_city" name="loc_city" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                        Valid first name is required.
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="loc_zip" name="loc_zip" placeholder="" value=""
                                        required>
                                    <div class="invalid-feedback">
                                        Valid first name is required.
                                    </div>
