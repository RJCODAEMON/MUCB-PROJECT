          ...
          <table style="width:100%;margin:0;padding:0" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tbody><tr>
              <td style="word-break:break-word;font-family:Lato,Tahoma,sans-serif;font-size:16px;height:25px;width:570px;margin:0 auto">
                <table class="m_5987997667473915512email-body_inner" style="width:570px;margin:0 auto;padding:10px 15px;background-color:#fff;background:#000" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tbody><tr>
            ...
            <tr>
              <td style="word-break:break-word;font-family:Lato,Tahoma,sans-serif;font-size:16px;width:100%;margin:0;padding:0" width="570" cellpadding="0" cellspacing="0">
                <table class="m_5987997667473915512email-body_inner" style="width:570px;margin:0 auto;padding:0;background-color:#fff" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
...
<p style="color:#51545e;margin:0.4em 0 1.1875em;font-size:16px;line-height:1.625">
  <a style="color:#fff;background-color:#3869d4;border-top:10px solid #3869d4;border-right:18px solid #3869d4;border-bottom:10px solid #3869d4;border-left:18px solid #3869d4;display:inline-block;text-decoration:none;border-radius:3px;box-sizing:border-box">Your Account is Here !</a>
</p>

<p style="color:#51545e;margin:0.4em 0 1.1875em;font-size:16px;line-height:1.625">Your Account  enables these features:</p>

<ul style="margin:0.4em 0 1.1875em;font-size:16px;line-height:1.625">


  <li>Book Inspection</li>
  <li>View Service that we offer</li>
</ul>


<h2 style="margin-top:0;color:#333;font-size:20px;font-weight:bold;text-align:left">
  Getting Started on MUCB
</h2>
...
<ul style="margin:0.4em 0 1.1875em;font-size:16px;line-height:1.625">
  <li><a style="color:#3869d4">Official Site</a></li>
            ...
            <tr>
              <td style="word-break:break-word;font-family:Lato,Tahoma,sans-serif;font-size:16px">
                <table class="m_5987997667473915512email-footer" style="width:570px;margin:0 auto;padding:0;text-align:center" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  <tbody><tr>
                    <td style="word-break:break-word;font-family:Lato,Tahoma,sans-serif;font-size:16px;padding:20px 45px" align="center">
                      <p style="color:#6f7073;margin:0.4em 0 1.1875em;font-size:13px;line-height:1.625;text-align:center">
